...
#import os
#c.MultiKernelManager.kernel_manager_class = 'lc_wrapper.LCWrapperKernelManager'#追加した
#c.NotebookApp.kernel_spec_manager_class = 'lc_wrapper.LCWrapperKernelSpecManager'#追加した
c.JupyterHub.authenticator_class = 'ltiauthenticator.LTIAuthenticator'
#c.JupyterHub.authenticator_class = 'nativeauthenticator.NativeAuthenticator'
c.LTIAuthenticator.consumers = {
    "86541eae521ae78cc16dbc2af385e96cf0724c9576f62e87b3ca8738119d3013": "6f7e96ef60cf1fc8e0998f7d5d8fa239b7d64326474576e70004db5e1a0b1230"
}
...
def pre_spawn_hook(spawner):
    ...
    #user_volume_dir_path = os.path.join('~/',username)
    try:
        pwd.getpwnam(username)
        #git clone https://github.com/ap21001/nbgrader_config.git
    except KeyError:
        subprocess.check_call(['sh', '/srv/jupyterhub/bootstrap-script/bootstrap.sh', username])

c.Spawner.pre_spawn_hook = pre_spawn_hook

c.Authenticator.admin_users = {'admin','admin-ap21001'}

#c.Authenticator.allowed_users = {'ikeda','admin-ap21001','admin','ap21001','aapp21001','testadduser2','adduser12345','test12345','testuser111','test222','test333','test444'}

#c.Authenticator.delete_invalid_users = True
c.LocalAuthenticator.create_system_users=True
#c.ScrapboxAPI.project_id = 'your-scrapbox-project-id'
#c.ScrapboxAPI.cookie_connect_sid = 'your-cookie-connect-sid-on-scrapbox'
#c.Authenticator.admin_users = {'admin','testadmin2','testadmin1'}
#c.Authenticator.allowed_users = {'testuser01','2','ikeda','admin'}
#c.PRConfig.access_token = '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'
#c.JupyterHub.authenticator_class = 'nativeauthenticator.NativeAuthenticator'# Configuration file for jupyterhub.
